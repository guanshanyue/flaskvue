...
class BaseConfig:
   ...
   # 配置session数据存储到redis数据库
    ...
    MAIL_USERNAME = 'nanteng@myweimai.com'  # 填邮箱
    MAIL_PASSWORD = 'KY@693dp'      # 填授权码
    FLASK_MAIL_SENDER = '皮皮虾！我们走！<nanteng@myweimai.com>'   #邮件发送方
...
class TestingConfig(BaseConfig):
    ...
    SQLALCHEMY_DATABASE_URI = "mysql+pymysql://root:123456@127.0.0.1:3306/rest"
